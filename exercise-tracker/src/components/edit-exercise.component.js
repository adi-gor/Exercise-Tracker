...
const EditExercise = () => {
  ...
  const onSubmit = () => {
    axios.post("https://exercise-tracker-backend-fnon.onrender.com/exercises/update/"+id, Exericse)
  };

  useEffect( () => {

    axios.get('https://exercise-tracker-backend-fnon.onrender.com/exercises/'+id)
      .then(response => {
        setExericse({
